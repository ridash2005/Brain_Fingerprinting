...
## Basic Parameters 
try:
    from .config_parser import parse_basic_params
    basic_parameters = parse_basic_params()
    HCP_DIR = basic_parameters.get('HCP_DIR', "./DATA")
    N_SUBJECTS = basic_parameters.get('N_SUBJECTS', 339)
    N_PARCELS = basic_parameters.get('N_PARCELS', 360)
except Exception:
    HCP_DIR = "./DATA"
    N_SUBJECTS = 339
    N_PARCELS = 360
